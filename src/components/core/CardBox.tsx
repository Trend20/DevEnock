...
const CardBox = (props: Readonly<CoreComponentsProps>) => {
  ...
  return (
    <div
      ...
      onClick={onClick}
      ref={elementRef}
      className={`relative w-full cursor-pointer flex flex-col justify-start items-start duration-500 border rounded-md hover:bg-zinc-800/10 hover:border-zinc-400/50 border-zinc-600 overflow-hidden group ${classNames}`}
    >
